...
% function [samples] = ucAnalogRead(port, SampleRate, NumSamples,TriggerMode,TriggerLevel,Decimation)
% ---------------------------------------------------
...
%           e.g. 'COM2'
%   SampleRate: requested sampling rate [Samples/s] (max. 15 kSamples/s)
%   NumSamples: number of samples to be recorded (max. 1500)
...
MAX_NUM_SAMPLES = 1500; % Samples
MIN_SAMPLE_RATE = 115;	% Samples/s
